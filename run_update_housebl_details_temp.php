...
if(!isset( $_SESSION['Uname'])){	
    ...
    $a = mysqli_query($dbc, "select * from temp_manifestation_breakdown where ConsignmentID='$cid' and HouseBL='$hbl' and MainBL='$mbl'");
    if(mysqli_num_rows($a)==0){
        ...
        $b = mysqli_query($dbc, "update temp_manifestation_breakdown set CosigneeID='$cns',Cosignee2_ID='$cns2',Description='$dsc',Weight='$wgt',ItemType='$type',VIN='$vin',OtherInfo='$oif',Package='$pkg',Unit='$unit' where ConsignmentID='$cid' and HouseBL='$hbl' and MainBL='$mbl'");
