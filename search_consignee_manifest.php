...
<script>
    $('.consignee_details_0_search').click(function(){
       ...
       $('#search_consignee_manifest').val(m);
       $('#consignee_id_invoice_nonm').text(cns);
       $('#hBL_conisgnee_weight').focus();
       
        $.post('insert_multi_values_0.php',{e1:cns},function(){
            $('#sel_bl_invoice_nonm').load('fetch_consignee_manifetst_bill.php');
        })
