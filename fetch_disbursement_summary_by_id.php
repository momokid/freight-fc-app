    ...
    <table class="table table-bordered table-responsive" style="padding:0px;" id="DisbursementProcessView">
        ...
        <tbody>
            ...
            ?>
                ...
                <tr>
                    <td scope='col' colspan="7" class="font-weight-bold text-danger">Disbursement Not Found Between <?= strftime("%B %d, %Y", strtotime($fdt)) ?> And <?= strftime("%B %d, %Y", strtotime($ldt))  ?></td>
                </tr>
            <?php } ?>
