...
?>
                ...
                <div style="height:1200px;">
                    <table class='m-4 tbl-heading' style='width:980px;'>
                        <thead>
                            <tr>
                                <td colspan="2" style='font-size:34px;'>PAYMENT RECEIPT</td>
                                <td></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <div style='text-align: center;border-bottom: 1px solid gray;' class="mt-4"><?php echo $bn['CouponID'] . ' - ' . $bn['ReceiptNo'] ?></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                    ...
                    <table class="table-striped table-bordered m-4" style='width:980px;font-size:20px;'>
                        <thead>
                            ...
                            <tbody>
                                <?php
                                $bb = mysqli_query($dbc, "select * from student_fee where Date<='$bn[Date]' and StudentID='$bn[StudentID]' and CouponID='$bn[CouponID]'");
