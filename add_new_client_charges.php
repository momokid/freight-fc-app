...
if(!isset( $_SESSION['Uname'])){	
    ...
    $a = mysqli_query($dbc, "select * from temp_other_invoice_view where Username='$Uname'");
    ...
    if(mysqli_num_rows($a)==0){
        die('Client charge(s) not yet added');
            ...
            if(mysqli_num_rows($b1)>0){
                ...
                if($r and $c  ){
                    $e = mysqli_query($dbc, "delete from temp_other_invoice where Username='$Uname'");
                    if($e){
                       $dbc->commit();
                        echo '1'; 
                    }else{
