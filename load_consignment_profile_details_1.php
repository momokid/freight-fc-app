...
?>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <?php 
                    $c = mysqli_query($dbc, "select * from  manifestation_breakdown_cargo_view where ConsignmentID='$an[LDate]' and MainBL='$an[SubjectID]'");
                    
                    if(mysqli_num_rows($c)==0){?>
                     
                    <td class="mbl-details-td" colspan="5">
                        <div class="div-mbl-view-2">
                            <span class="mbl-details-body text-danger">Manifest breakdown for consignment not processed.</span>
                        </div>
                    </td>
                
                   <?php }else{?>
                    <td class="mbl-details-td" colspan="5">
                        <div class="div-mbl-view-2" style="display: block;text-align: center;">
                            <span class="mbl-details-body text-success">Details of Manifest Breakdown <i class="fas fa-arrow-circle-down text-danger faa-bounce animated"></i></span>
                        </div>
                    </td>
                           ...
                           <tr>
                            <td class="mbl-details-td">
                                <div class="div-mbl-view-2">
                                    ...
                                    <br>
                                    <span class="mbl-details-body"><?php echo $cn['FullName']; ?></span>
                                </div>
                            </td>
                            <td class="mbl-details-td">
                                <div class="div-mbl-view-2">
                                    ...
                                    <br>
                                    <span class="mbl-details-body"><?php echo $cn['HouseBL']; ?></span>
                                </div>
                            </td>
                            <td class="mbl-details-td">
                                <div class="div-mbl-view-2">
                                    ...
                                    <br>
                                    <span class="mbl-details-body"><?php echo $cn['Description']; ?></span>
                                </div>
                            </td>
                            <td class="mbl-details-td">
                                <div class="div-mbl-view-2">
                                    ...
                                    <br>
                                    <span class="mbl-details-body"><?php echo $cn['Weight']; ?></span>
                                </div>
                            </td>
                            <td class="mbl-details-td">
                                <div class="div-mbl-view-2">
                                    <span class="mbl-details-head">Package Unit</span>
                                    <br>
                                    <span class="mbl-details-body"><?php echo $cn['Package'].''.$cn['Unit']; ?></span>
                                </div>
                            </td>
                        </tr>
                      <?php }?>
                         <tr>
                            <td class="mbl-details-td" colspan="5">
                                <div class="div-mbl-view-2" style="display: block;text-align: center;">
                                    <span class="mbl-details-body text-danger">View Manifest Breakdown <i class="fas fa-eye text-primary faa-shake animated prvw-manifest-breakdown" id="<?php echo $bn['BL']; ?>"></i></span>
                                </div>
                            </td>
                       </tr>
                   <?php }
