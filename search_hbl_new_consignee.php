...
if(!isset($_SESSION['Uname'])){
  ...
  while( $f = mysqli_fetch_assoc($result)){
      ...
      echo "<div class='return_search_results consignee_details_0_search hide_div_note'  cns='$f[ConsigneeID]' ><b>".$f['FullName']."</b> ".$f['TelNo']."</div>";
  }
...
<script>
    $('.consignee_details_0_search').click(function(){
       ...
       $('#search_hbl_consignee_fname').val(m);
       $('#search_hbl_consignee2_fname').val(m);
       $('#hbl_consignee_id').text(cns);
