...
<head>
    <title>EXPENDITURE REPORT BY ACCOUNT</title>
    <?php
    include 'script.php';
    ?>
</head>
...
<body style="border: 0px solid green;">
    ...
    <div style="height: 0px;" class="m-3">
        ...
        <input class="btn btn-dark no-print" type="button" onClick="window.open('view_expenditure_report.php')" value="PRINT VIEW">
    </div>
</body>
