...
<!-- Online Request -->
<div class="col-xl-3 col-md-6 mb-4 freight_alerts" data-toggle="modal" data-target="#onlineRequest" id="online_request">
  <div class="card border-left-info shadow h-100 py-2">
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          <div class="text-xs font-weight-bold text-info text-uppercase mb-1">payment confirmation</div>
          <div class="row no-gutters align-items-center">
            <div class="col-auto">
            <div class="h5 mb-0 font-weight-bold text-gray-800" id="online_request_count">Loading...</div>
            </div>
          </div>
        </div>
        <div class="col-auto">
...
<div class="modal fade" id="onlineRequest" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog  modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          ...
          <div class="form-group row">
            <div class="col-lg-12 mb-4" id="display_online_request_status">
              <!-- Approach -->
                <p>...Loading data</p>
            </div>
          </div>
