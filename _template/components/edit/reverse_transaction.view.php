...
<div class="container-fluid sub-basic-setup" id="reverse-transaction-panel">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Reverse Transaction </h1>
  </div>
  ...
  <div class="row">
    ...
    <!-- Content Column -->
    <div class="col-sm-4 mb-2 sr-only">
        ...
        <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-12 mb-3">
              <button type="button" class="btn btn-outline-success" id="btn_get_bl_reversal">Search BL#</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-sm-4 mb-2">
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          ...
          <div class="form-group row">
            <div class="col-sm-12 mb-3 mb-sm-3">
              <label for="exampleFormControlInput1">Transaction#</label>
              <label type="text" class="form-control ep" hidden='' id='cns_id_wieght_edit_search'></label>
              <input type="text" class="form-control form-control-user ep" id="search_transaction_edit" placeholder="Enter Receipt#">
              <div id='display_cns_weight_edit_info' class='div_search_box'></div>
            </div>
            <div class="col-sm-12 mb-3">
              <button type="button" class="btn btn-outline-success" id="btn_get_receiptno_reversal">Search Receipt#</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-sm-12 mb-1">
      ...
      <div class="card shadow mb-1" id="manifestation_breakdown_card">
        ...
        <div class="card-body">
          <div class="form-group row">
            <div class="col-sm-12 mb-1 mb-sm-0" id="display_search_results_edit">
