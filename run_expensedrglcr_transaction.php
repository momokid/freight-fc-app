            ...
            if (mysqli_num_rows($c) > 0) {
                ...
                if ($dt > $ajaxDate) {
                    ...
                    if (mysqli_num_rows($d) <> 1) {
                        ...
                        $f = $dbc->query("insert into journal values('$glCr','$glCr','Cr','NCash','$recno','0','$amt','$desc','$dt','$ajaxTime','$Uname','N.Auth','$BranchID','1')");
                        $m = $dbc->query("insert into journal values('$dn[AccountID]','$glDr','Dr','NCash','$recno','$amt','0','$desc','$dt','$ajaxTime','$Uname','N.Auth','$BranchID','1')");
                        $g = $dbc->query("insert into pnl_transaction values('$glDr','NB','Dr','DrExpCrGL','DrExpCrGL','$recno','$desc','$amt','0','$dt','$ajaxTime','$BranchID','$Uname','1')");
