...
<head>
  ...
  <title>Front Desk Model - Freight Diary</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <?php $exp_q = mysqli_query($dbc, "select * from user_expense_petty_cash where Username='$Uname'"); ?>
      ...
      <li class="nav-item">
        ...
        <div id="EditDataTab" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-success py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" id="">Reverse Transaction</a>
            <div class="collapse-divider"></div>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <?php
        include_once "script_user_profile.php";
        ?>
            ...
            <div class="col-sm-5 mb-4">
              ...
              <div class="card shadow mb-4" id="manifestation_breakdown_card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <form class="user">
                      <a class="btn btn-success btn-user btn-block" id="btn_add_charge_consignee_invoice">
                        Add/Update Charge
                      </a>
                    </form>
                  </div>
            ...
            <div class="col-sm-5 mb-2">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <div class="col-sm-12 mb-3 mb-sm-0">
                      <label for="exampleFormControlInput1">Search Client Name</label> <i class="fas fa-plus text-danger float-right ml-3" data-toggle="modal" data-target="#newConsigneeModal" id="addCleintModal"></i><i class="fas fa-eye text-warning float-right sr-only" data-toggle="modal" data-target="#consigneeInProcessModal" id="load_consignee_in_process_others"></i>
                      <label type="text" class="form-control ep sr-only" id='search_client_oth_serv_id'></label>
                      <input type="text" class="form-control form-control-user ep client-det-search" id="" autocomplete="off" placeholder="">
...
<!-- /. End of Disbursement Analysis Content -->
        ...
        <div class="container-fluid sub-basic-setup" id="edit-consignment-weight">
          ...
          <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Consigment Weight</h1>
          </div>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Garimo eNovations Ltd - 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
