$(function () {
  ...
  //Ftech GL Credit Account (DrGlCrIncome) balance
    ...
    $.post(
      ...
      function (a) {
        if (a == 1) {
          ...
          $.post('load_consignee_handling_charges_temp_tbl.php', {}, function (
            a,
          ) {
    ...
    if (name == '') {
      ...
      $.post(
        ...
        function (a) {
          if (a == 1) {
            //Display Consignee handling charges
            $.post('load_client_handling_charges_temp_tbl.php', {}, function (
              a,
            ) {
          ...
          function (a) {
            if (a == 1) {
              ...
              $('#display_new_consignment').load(
                'load_new_pending_consignment.php',
              )
              $('#display_new_container_details').load(
                'load_new_pending_container_details_temp.php',
              )
  ...
  $('#btn-add-subjCategory').click(function () {
    ...
    if (CID == '') {
      ...
      $.post('run_new_subjCategory.php', { CID: CID, CName: CName }, function (
        a,
      ) {
        if (a == 1) {
      ...
      $.post(
        ...
        function (e) {
          if (e == 1) {
            ...
            $.post('load_new_subject_id.php', { CID: CID, CN: CN }, function (
              a,
            ) {
              $('#subjnameID').text(a)
            })
  ...
  $('#editScore_SelTestType_tch').change(function () {
    ...
    if (name == '') {
      ...
      $.post('insert_sel_class_subj_recScore.php', { Class: tid }, function (
        a,
      ) {
        if (a == 1) {
  ...
  $('#recScore_Student').change(function () {
    ...
    $.post('insert_sel_class_subj_recScore.php', { Class: Class }, function (
      a,
    ) {
      if (a == 1) {
  ...
  $('#btn-StdrecordScore').click(function () {
    ...
    $.post('load_students_subj_test_score.php', {}, function () {
      $('#temp_student_recTestScore').load('load_temp_student_recTestScore.php')
    })
  ...
  $('#btn-edit-student_test_score_tch').click(function () {
    ...
    if (q) {
      if (sbj == '' || sbj == '...') {
        ...
        $.post('run_student_record_test_update.php', { cpn: cpn }, function (
          a,
        ) {
          if (a == 1) {
  ...
  $('#btn-new-control-ledger').click(function () {
    ...
    if (CID == '') {
      ...
      $.post('add_new_ledger_control.php', { CID: CID, CNM: CNM }, function (
        a,
      ) {
        if (a == 1) {
          $('#newledgerControlID').load('get_new_ledger_controlID.php')
  ...
  $('#btn-editStaffProfile').click(function () {
    $('#edit_staff_profile_details').load('load_edit_staff_profile_details.php')
    // $('#subject-main-tbl').html('');
  })
  ...
  $('#btn-new-admision-account-map').click(() => {
    let classid = $.trim($('#sel_MapAdmisionFeeClass :selected').attr('id'))
    let clas = $.trim($('#sel_MapAdmisionFeeClass').val())
    let accountid = $.trim($('#sel_MapAdmisionFeeAccount :selected').attr('id'))
  ...
  $('#btn-SetActiveActiveWriteOff').click(function () {
    ...
    if (nm == '') {
      ...
      $.post('run_set_active_fee_write_off.php', { id: id, nm: nm }, function (
        e,
      ) {
        if (e == 1) {
          $('#txt_SetActiveWriteOff').load('load_active_fees_write_off.php')
  ...
  $('#btn-reset-student_test_score_tch').click(function () {
    ...
    if (q) {
      ...
      $.post('reset_marking_list_student_test_scores_tch.php', {}, function (
        e,
      ) {
        if (e == 1) {
          $('#temp_student_recTestScore_tch').load(
  ...
  $('#tab_std_promo_gen').click(function () {
    $('#sel_student_promo_subclass').load('load_sel_gen_std_promo_subclass.php')
  ...
  $('#rptmarkTest_SelAcademic').change(function () {
    ...
    if (title == '') {
      ...
      $.post('insert_receipt_no.php', { e: cpn }, function (e) {
        if (e == 1) {
          $('#rptmarkTest_SelSubject').load('load_academic_test_type_0_tch.php')
          $('.progress-loader').remove()
        } else {
          alert(e)
          $('.progress-loader').remove()
  ...
  $('#btn-rpt-subj-marked-testType_det_tch').click(function () {
    ...
    var sbid = $.trim($('#rptmarkTest_SelSubject_det_tch :selected').attr('id'))
  ...
  $('#btn-SetActiveFeeRcvbl').click(function () {
    ...
    if (nm == '') {
      ...
      $.post('run_set_active_fee_receivable.php', { id: id, nm: nm }, function (
        e,
      ) {
        if (e == 1) {
          $('#txt_SetActiveFeeRcvbl').load('load_active_fees_receivables.php')
  ...
  $('#btn_check_available_ticket').click(function () {
    let cpn = $.trim($('#sel_issueTicket_academic_coupon :selected').attr('id'))
  ...
  $('#btn-gen_termRpt_ticket').click(function () {
    ...
    if (cl == '') {
      ...
      if (q) {
        ...
        $.post('generate_algor_means.php', { cid: cid, cpn: cpn }, function (
          t,
        ) {
          if (t == 1) {
            $('.progress-loader').remove()
