   ...
   // $b = mysqli_query($dbc, "select * from inst_branch_view where BranchID='$BranchID'");
    ...
    if(mysqli_num_rows($a)==0){
       die('Error detected: Consignment Details not recorded.');
        ...
        $b = mysqli_query($dbc, "select * from  manifestation_breakdown_cargo_view where HouseBL='$an[LDate]'");
            ...
            <td class="mbl-details-td">
                <div class="div-mbl-view-2">
                    ...
                    <select class="custom-select custom-select-sm sl-form-ctrl edit-var" id="edit_hbl_cn1">
                        <option id="<?php echo $bn['ConsigneeID']; ?>" ><?php echo $bn['FullName']; ?></option>
                        <?php 
            ...
            <td class="mbl-details-td">
                <div class="div-mbl-view-2">
                    ...
                    <select id="edit_hbl_cn2" class="custom-select custom-select-sm sl-form-ctrl edit-var">
                        <option id="<?php echo $bn['Consigenee2_ID']; ?>" ><?php echo $bn['FN']; ?></option>
                        <?php 
                            $a = mysqli_query($dbc, "select * from consignee_main where ConsigneeID<>'$bn[Consigenee2_ID]' order by FullName");
                            while($an = mysqli_fetch_assoc($a)){?>
                        <option id="<?php echo $an['ConsigneeID']; ?>" ><?php echo $an['FullName']; ?></option>
                           <?php }?>
                    </select>
        ...
        <tr>
            <td class="mbl-details-td">
                <div class="div-mbl-view-2">
                    ...
                    <br>
                    <span class="mbl-details-body" id="edit_hbl_mbl"><?php echo $bn['Weight']; ?></span>
                </div>
            </td>
            <td class="mbl-details-td">
                <div class="div-mbl-view-2">
...
<script>
  ...
  $('#btn-update-hbl-details').click(function(){
      ...
      if(q){
          ...
          $.post('run_update_housebl_details.php',{hbl:hbl,cid:cid,cn1:cn1,cn2:cn2,pkg:pkg,gwt:gwt,unt:unt,mbl:mbl,itp:itp,dsc:dsc,vin:vin,oif:oif},function(a){
              if(a==1){
