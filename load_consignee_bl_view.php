...
if (!isset($_SESSION['Uname'])) {
    ...
    if (mysqli_num_rows($b) == 0) {
        ...
        if (mysqli_num_rows($a) == 0) {
            ...
            $h = mysqli_query($dbc, "SELECT * FROM consignment_profile_view WHERE ConsigneeID='$an[SubjectID]' AND BL='$an[Sub_ClassID]'");
...
<body style="border: 0px solid green;position: relative;width:1000px;">
    ...
    <?php
    $c = mysqli_query($dbc, "SELECT * FROM consignment_profile_view WHERE ConsigneeID='$an[SubjectID]' AND BL='$an[Sub_ClassID]'");

    if (mysqli_num_rows($c) == 0) {
        die('BL details not found');
    } else {
        ...
        <table class="" style="font-family: Calibri;margin-top: 5px;color:black;margin-left: 10px;margin-top: 40px;z-index: 1; border:6px dashed #7e4430;width:1000px;">
            ...
            <td class="hbl-inv-td" colspan="2">
                <div class="div-hbl-inv-2">
                    ...
                    <br>
                    <span class="hbl-inv-body"><?= nl2br($en['ShipperName'], false); ?></span><br>
                    <span class="hbl-inv-body"><?= nl2br($en['AddressLine1'], false); ?></span><br>
                    <span class="hbl-inv-body"><?= nl2br($en['AddressLine2'], false); ?></span><br>
                    <span class="hbl-inv-body"><?= nl2br($en['AddressLine3'], false); ?></span>
                </div>
                ...
                <div class="div-hbl-inv-2" style="border:0px solid black; border-right: 1px solid black;">
                    ...
                    <br>
                    <span class="hbl-inv-body"><?= $dn['FullName']; ?></span><br>
                    <span class="hbl-inv-body"><?= nl2br($dn['Address1'], false); ?></span><br>
                    <span class="hbl-inv-body"><?= nl2br($dn['Address2'], false); ?></span><br>
                    <span class="hbl-inv-body"><?= nl2br($dn['Address3'], false); ?></span>
                </div>
                <?php $d = mysqli_query($dbc, "SELECT * FROM consignee_main WHERE ConsigneeID='$cn[ConsigneeID]'");
                if (mysqli_num_rows($d) <> 1) {
                ...
                <?php if ($cn['ConsigneeID'] == $cn['Consigenee2_ID']) { ?>
                    <div class="div-hbl-inv-2" style='border-bottom:0px;'>
                        ...
                        <br>
                        <span class="hbl-inv-body"><?= "SAME AS CONSIGNEE"; ?></span><br>
                ...
                <?php } else { ?>
                    <div class="div-hbl-inv-2" style='border-bottom:0px;'>
                        ...
                        <br>
                        <span class="hbl-inv-body"><?= $dn['FullName']; ?></span><br>
                        <span class="hbl-inv-body"><?= $dn['Address1']; ?></span><br>
                        <span class="hbl-inv-body"><?= $dn['Address2']; ?></span><br>
                        <span class="hbl-inv-body"><?= $dn['Address3']; ?></span>
                    </div>
                <?php  } ?>
            ...
            <td class="hbl-inv-td" colspan="2">
                <div style="float: top;border:0px solid black;height: 450px;">
                    <div>
                        ...
                        <div style="border: 1px solid black;float: left;padding-left:5px ;font-weight:bold;font-size: 14px;width: 250px;margin-top: 10px;">Bill of Lading Number <br> <?= $cn['HouseBL'] ?> </div>
            ...
            <tr style="border:1px solid black;border-left: 0px;border-right: 0px;">
                <td colspan="2" style="border-right:1px solid black;">
                    ...
                    <div>
                        ...
                        <br>
                        <span class="hbl-inv-body"><?= $dn['VesselName']; ?> <?= $dn['VoyageNo']; ?></span><br>
                    </div>
                </td>
                <td>
                    <div>
                        ...
                        <br>
                        <span class="hbl-inv-body"><?= $dn['POL_Name']; ?></span><br>
                    </div>
                </td>
            ...
            <tr style="border:1px solid black;border-left: 0px;border-right: 0px;">
                <td style="border-right:1px solid black;">
                    <div>
                        ...
                        <br>
                        <span class="hbl-inv-body"><?= $dn['POD_Name']; ?></span><br>
                    </div>
                </td>
                <td style="border-right:1px solid black;">
                    <div>
            ...
            <tr style="border:0px solid black;">
                ...
                <td style="border-right:1px solid black;text-align: center;">
                    <div>
                        ...
                        <br>
                        <span class="hbl-inv-body">1X<?= $dn['ContainerSize'] ?> PART CONT.</span><br>
                    </div>
                </td>
                <td style="border-right:1px solid black;text-align: center;">
                    <div>
                        ...
                        <br>
                        <span class="hbl-inv-body"><?= nl2br($fn['Description'], false) ?></span><br>
                        <?php if ($fn['VIN'] <> '') { ?>
                            <span class="hbl-inv-body"><?= nl2br($fn['VIN'], false) ?></span><br>
                        <?php } else {
                        } ?>
                        <?php if ($fn['OtherInfo'] <> '') { ?>
                            <span class="hbl-inv-body"><?= nl2br($fn['OtherInfo'], false) ?></span><br>
                        <?php } else {
                        } ?>
                    </div>
                </td>
                <td style="border-right:1px solid black;text-align: center;">
                    <div>
                        ...
                        <br>
                        <span class="hbl-inv-body"><?= $fn['Weight'] ?></span><br>
                    </div>
                </td>
                ...
                <td colspan="4" class="tr-inv-4">
                    <div>
                        <div>
                            ...
                            <br>
                            <span class="hbl-inv-body"><?= $hn['ContainerNo'] ?></span><br>
                        </div>
                        <div>
                            <span class="hbl-inv-head"> Seal </span>
                            <br>
                            <span class="hbl-inv-body"><?= $hn['SealNo'] ?></span><br>
                        </div>
                        <div>
                            <span class="hbl-inv-head"> Type </span>
                            <br>
                            <span class="hbl-inv-body"><?= $dn['ContainerSize'] ?></span><br>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <br>
                            <span class="hbl-inv-body"><?= $fn['Package'];
                                                        if ($fn['Package'] > 1) {
                                                            echo $fn['Unit'] . 'S';
                                                        } else {
                                                            echo $fn['Unit'];
            ...
            <tr style="border:0px solid black;border-left: 0px;border-right: 0px;" colspan='2'>
                <td colspan="2" style="border:1px solid black;border-left: 0px solid black;">
                    ...
                    <div style="text-transform:uppercase;">
                        ...
                        <br>
                        <span class="hbl-inv-body"><?= $bn['InstName']; ?></span><br>
                        <span class="hbl-inv-body"><?= $bn['Address']; ?></span><br>
                        <span class="hbl-inv-body"><?= $bn['Location']; ?></span><br>
                        <span class="hbl-inv-body">TEL: <?= $bn['TelNo']; ?></span><br>
                        <span class="hbl-inv-body">EMAIL: <span style="text-transform:lowercase"><?= $bn['Email']; ?></span></span><br><br>
                    </div>
                </td>
            ...
            <tr style="border:0px solid black;border-left: 0px;border-right: 0px;">
                <td style="border-right:1px solid black;" colspan="2">
                    <div>
                        ...
                        <br>
                        <span class="hbl-inv-body pr-4 mb-4"><?= $cn['POIS']; ?></span> <span class="hbl-inv-body"><?= strftime("%b %d, %Y", strtotime($cn['DOIS'])); ?></span><br><br>
            ...
            <tr style="border:0px solid black;border-right: 0px;">
                ...
                <td style="border:1px solid black;border-left: 0px;">
                    <div>
                        ...
                        <br>
                        <span class="hbl-inv-body pr-4 mb-4 text-white">.</span><br>
                        <span class="hbl-inv-body"><?= strftime("%b %d, %Y", strtotime($cn['SOB'])); ?></span>
                    </div>
                </td>
                <td style="border:0px solid black; border-left: 0px solid black;" colspan="2">
                    <div>
