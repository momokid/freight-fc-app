...
if(!isset( $_SESSION['Uname'])){	
   ...
   $a = mysqli_query($dbc, "select distinct ConsigneeID,FullName,Description,Weight,Package,Unit,HouseBL,MainBL,ConsignmentID from  manifestation_breakdown_view_0 where ConsigneeID='$cns' and HouseBL='$hbl'");
