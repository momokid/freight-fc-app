...
<div class="col-sm-4 mb-1">
    ...
    <div class="card shadow mb-1">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">EXPENDITURE REPORT</h6>
        </div>
        <div class="card-body">
            <select class="form-control mb-3 sel_branch_rpt" id="sel_expenditure_rpt_branch">
...
<div class="modal animated--grow-in" id="modalExpenseRpt" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title" id="exampleModalLabel">EXPENDITURE REPORT PREVIEW</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body" id="display_ExpenseRpt">
