...
<div class="col-sm-4 mb-1">
    ...
    <div class="card shadow mb-1">
        ...
        <div class="card-body">
            <select class="form-control mb-3 sel_branch_rpt" id="sel_income_sttmnt_branch" disabled>
                <option></option>
            </select>
...
<!-- Income Report Modal-->
<div class="modal animated--grow-in" id="modalIncomeSttmnt" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title" id="exampleModalLabel">INCOME STATEMENT PREVIEW</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body" id="display_IncomeSttmnt">
                <span>Loading...</span>
            </div>
