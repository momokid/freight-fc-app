    ...
    <table class="table table-bordered table-responsive" style="padding:0px;" id="dataTables">
      ...
      <tbody>
        ...
        while ($an = mysqli_fetch_assoc($a)) {
          ...
          <tr>
            ...
            <td scope="col"> <?= formatToCurrency($Total); ?> </td>
            <td scope="col"> <?= formatToCurrency($an['GTotal']); ?></td>
            <td scope="col"><i class="fa fa-trash text-danger rm-client-charges-nonm ml-3" acc="<?= $an['AccountNo'] ?>"></i></td>
          </tr>
      <?php   }
      ...
      <script>
        ...
        $('#btn_save_client_invoice_nonm').click(function() {
          ...
          let hbl = $("#sel_bl_invoice_nonm :selected").attr('mbl');
