...
<head>
    <title>INCOME REPORT BY ACCOUNT</title>
    <?php
    include 'script.php';
    ?>
</head>
...
<body style="border: 0px solid green;">
    ...
    <table class="" style="width:1000px;border: 0px solid red;margin-top: 5px;color:black;margin-left: 10px;">
        ...
        <tbody>
            ...
            <?php $e = mysqli_query($dbc, "select round(sum(Cr)-sum(Dr),2) as TInc from  pnl_transaction_general where AccountID='$an[Value1]' and (Date BETWEEN '$an[FDate]' and '$an[LDate]')");
