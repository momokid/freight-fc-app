    ...
    if(mysqli_num_rows($b)==0){
       die('Error detected: Report not genarated.');
        ...
        if(mysqli_num_rows($a)==0){
            ...
            $h = mysqli_query($dbc, "select * from hbl_invoice_view_1 where ReceiptNo='$an[SubjectID]'");
...
<html>
    ...
    <body style="border: 0px solid black;position: relative;width:1000px;">
        ...
        <?php  
            ...
            ?> 
        <table class="" style="font-family: Calibri;color:black;margin-left: 10px;margin-top: 10px;z-index: 1;" id="">
            <tr>
                ...
                <td class="hbl-inv-td" colspan="2">
                    <div class="div-hbl-inv-2">
                        ...
                        <br>
                        <span class="hbl-inv-body"><?php echo $en['ShipperName']; ?></span><br>
                        <span class="hbl-inv-body"><?php echo $en['AddressLine1']; ?></span><br>
                        <span class="hbl-inv-body"><?php echo $en['AddressLine2']; ?></span><br>
                        <span class="hbl-inv-body"><?php echo $en['AddressLine3']; ?></span>
                    </div>
                ...
                <?php $d = mysqli_query($dbc, "select * from consignee_main where ConsigneeID='$cn[Consignee2_ID]'"); 
                    if(mysqli_num_rows($d)<>1){
                ...
                <td class="hbl-inv-td" colspan="2">
                    <div style="float: top;border:0px solid black;height: 450px;">
                        <div>
                            ...
                            <div style="border: 1px solid black;float: left;padding-left:5px ;font-weight:bold;font-size: 14px;width: 250px;margin-top: 10px;">Bill of Lading Number <br> <?php echo $cn['MainBL'] ?> </div>
                            <div style="background-image: url('img/psil.png'); background-size: cover;float: left;width: 100%;height: 110px;margin-top: 30px;"></div>
                            <div style="float: left; font-size: 12px;margin-top: 60px;font-weight:bold;padding: 10px;">Received by the carrier, the goods as specified below in apparent goods order and condition, either
            ...
            <tr style="border:1px solid black;border-left: 0px;border-right: 0px;">
                ...
                ?>
                    <div>
                        ...
                        <br>
                        <span class="hbl-inv-body"><?php echo $dn['VesselName']; ?></span><br>
                    </div>
                </td> 
                <td>
                    <div>
            ...
            <tr style="border:0px solid black;">
                <?php $d = mysqli_query($dbc, "select * from manifestation_breakdown_cargo_view where ConsignmentID='$cn[ConsignmentID]' and MainBL='$cn[MainBL]' and HouseBL='$cn[HouseBL]' and ConsigneeID='$cn[ConsigneeID]'"); 
                    if(mysqli_num_rows($d)<>1){
                        die('Cargo manifest details not found');
                    }else{
                        $fn = mysqli_fetch_assoc($d);
                    }
                ?>
                <td style="border-right:0px solid black;text-align: center;">
                    <div>
                ...
                <td style="border-right:0px solid black;text-align: center;">
                    <div>
                        ...
                        <br>
                        <span class="hbl-inv-body"><?php echo $fn['Description'] ?></span><br>
                    </div>
                </td>
                <td style="border-right:0px solid black;text-align: center;">
                    <div>
                        <span class="hbl-inv-head">Gross Weight Kgs</span>
                        <br>
                ...
                <td colspan="4" class="tr-inv-4">
                    <div>
                        <div>
                            ...
                            <br>
                            <span class="hbl-inv-body"><?php echo $dn['ContainerNo'] ?></span><br>
                        </div>
                        <div>
                            <span class="hbl-inv-head"> Seal </span>
                            <br>
                            <span class="hbl-inv-body"><?php echo $dn['SealNo'] ?></span><br>
                        </div>
                        <div>
                            <span class="hbl-inv-head"> Type </span>
                            <br>
                            <span class="hbl-inv-body"><?php echo $dn['ContainerSize'] ?>GP</span><br>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <br>
                            <span class="hbl-inv-body"><?php echo $fn['Package']; if($fn['Package']>1){echo $fn['Unit'].'S';}else{echo $fn['Unit'];} ?></span><br>
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <tr style="border:0px solid black;border-left: 0px;border-right: 0px;" colspan='2'>
                ...
                ?>
                    <div style="text-transform:uppercase;">
                        ...
                        <span class="hbl-inv-body"><?php echo $bn['BranchName']; ?></span><br><br>
            ...
            <tr style="border:0px solid black;border-left: 0px;border-right: 0px;">
                <td style="border-right:1px solid black;" colspan="2">
                    <div>
                        ...
                        <br>
                        <span class="hbl-inv-body pr-4 mb-4"><?php echo $en['AddressLine3']; ?></span> <span class="hbl-inv-body"><?php echo strftime("%b %d, %Y", strtotime($fn['ETA'])); ?></span><br><br>
            ...
            <tr style="border:0px solid black;border-right: 0px;">
                <td style="border:1px solid black;border-left: 0px;">
                    <div>
                        <span class="hbl-inv-head">Place of Receipt:</span>
                        <br>
                ...
                <td style="border:1px solid black;border-left: 0px;">
                    <div>
                        ...
                        <br>
                        <span class="hbl-inv-body pr-4 mb-4 text-white">.</span><br>
                        <span class="hbl-inv-body"><?php echo strftime("%b %d, %Y", strtotime($fn['ETA'])); ?></span>
                    </div>
                </td>
                <td style="border:0px solid black; border-left: 0px solid black;" colspan="2">
                    <div>
